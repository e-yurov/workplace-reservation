...
import com.rc.mentorship.workplace_reservation.auth.UserDetailsService;
...
public class JwtFilter extends OncePerRequestFilter {
    private static final String EXCLUDED_URI = "/api/v1/auth";
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        return request.getRequestURI().startsWith(EXCLUDED_URI);
    }
}
